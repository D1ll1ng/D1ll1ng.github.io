...
var book_svelte_svelte_type_style_lang = "";
const css = {
...
<div class="${"content svelte-cf77e8"}"><h1>About this app</h1>
	...
	<div class="${"gallery-images"}"><img src="${"https://assets.maxroll.gg/wordpress/D2_Amazon.jpg"}" alt="${"contentimage"}" style="${"width:800px; height:200px"}"></div>

</div>`;
});
export { Book as default, hydrate, router };
